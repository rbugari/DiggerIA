...
export const DeepTransformNode = memo(({ data, selected }: NodeProps) => {
    return (
        <NodeWrapper selected={selected} className="border-purple-200 dark:border-purple-900/50">
            <Handle type="target" position={Position.Left} className="w-3 h-3 border-2 border-purple-500 bg-background !-left-1.5" />
            ...
            <Handle type="source" position={Position.Right} className="w-3 h-3 border-2 border-purple-500 bg-background !-right-1.5" />
        </NodeWrapper>
    );
});
...
export const DeepTableNode = memo(({ data, selected }: NodeProps) => {
    ...
    return (
        <NodeWrapper selected={selected} className="border-emerald-200 dark:border-emerald-900/50">
            <Handle type="target" position={Position.Left} className="w-3 h-3 border-2 border-emerald-500 bg-background !-left-1.5" />
            ...
            <Handle type="source" position={Position.Right} className="w-3 h-3 border-2 border-emerald-500 bg-background !-right-1.5" />
        </NodeWrapper>
    );
});
